...
const COURSE_MAJOR_DEFS: OptionDef[] = [
  ...
  { id: 'publicHealth', value: 'Public Health' },
  { id: 'pharmacy', value: 'Pharmacy' },
  { id: 'informationTechnology', value: 'Information Technology' },
  { id: 'financeAccounting', value: 'Finance & Accounting' },
  { id: 'politicalScienceInternationalRelations', value: 'Political Science & International Relations' },
  { id: 'biologyLifeSciences', value: 'Biology & Life Sciences' },
  { id: 'chemistry', value: 'Chemistry' },
  { id: 'physics', value: 'Physics' },
  { id: 'journalism', value: 'Journalism' },
  { id: 'fineArtsDesign', value: 'Fine Arts & Design' },
  { id: 'hospitalityTourismManagement', value: 'Hospitality & Tourism Management' },
  { id: 'humanResourceManagement', value: 'Human Resource Management' },
  { id: 'marketing', value: 'Marketing' },
  { id: 'veterinaryMedicine', value: 'Veterinary Medicine' },
  { id: 'urbanRegionalPlanning', value: 'Urban & Regional Planning' },
  { id: 'dataScience', value: 'Data Science' },
  { id: 'sportsScience', value: 'Sports Science' },
  { id: 'geologyEarthSciences', value: 'Geology & Earth Sciences' },
  { id: 'theologyReligiousStudies', value: 'Theology & Religious Studies' },
];
